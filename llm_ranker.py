...
def _system_prompt(policy: dict) -> str:
    ...
    return (
        ...
        f"also recommend Intermediate (event 1931656) at the exact same start time on a different court — "
        f"this lets the over-classified AI players self-select into Intermediate when they see it running alongside\n"
